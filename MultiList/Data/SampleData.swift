...
let sampleList: [SectionList] = [
    SectionList(order: 0, sectionName: "개인", color: 0, multiList: [sampleMultiList1, sampleMultiList2, sampleMultiList3]),
    SectionList(order: 1, sectionName: "공유", color: 1, multiList: [sampleMultiList4])
    ]
// 0-2. 샘플 친구 리스트
let samplefriends = [
...
// 0-1-1. 샘플 멀티 리스트
let sampleMultiList1 = MultiList(multiID: contentID01, order: 0, listType: .textList, isSettingDone: true)
let sampleMultiList2 = MultiList(multiID: contentID02, order: 1, listType: .checkList, isSettingDone: true)
let sampleMultiList3 = MultiList(multiID: contentID03, order: 2, listType: .none)
let sampleMultiList4 = MultiList(multiID: contentID04, order: 0, listType: .linkList, isSettingDone: true)
...
// 0-1-1-1. 샘플 리스트
let sampleTextList = TextList(id: contentID01, title: "텍스트 리스트", itemList: [
    TextRow(order: 0, title: "1"),
    TextRow(order: 0, title: "2"),
    TextRow(order: 0, title: "3"),
    TextRow(order: 0, title: "4"),
    TextRow(order: 0, title: "5")
])
let sampleCheckList = CheckList(id: contentID02, title: "체크 리스트", itemList: [
...
let sampleLinkList = LinkList(id: contentID04, title: "링크 리스트", itemList: [
