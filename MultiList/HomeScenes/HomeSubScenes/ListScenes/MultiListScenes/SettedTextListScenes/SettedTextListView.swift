...
struct SettedTextListView: View {
    ...
    init(userData: UserData, textList: TextList, color: Color, width: CGFloat) {
...
extension SettedTextListView {
    ...
    func contentTypeView(proxy: GeometryProxy) -> some View {
        HStack(content: {
            ...
            .frame(width: width * 0.35, height: width * 0.3)
...
#Preview {
    SettedTextListView(userData: UserData(), textList: TextList(title: "sample TextList"), color: .brown, width: 150)
}
