...
#define kServiceAppUrlScheme    @"naver.yeonhoc5.multilist"

#define kConsumerKey            @"ZvSuX1YVTdTCkHgFlReB"
#define kConsumerSecret         @"6JqJ8N3raB"
#define kServiceAppName         @"MultiList"
